<?php
  ...
  if (isset($_SESSION['userid'], $_SESSION['userrole']) && $_SESSION['userrole'] === 'admin') {
    try {
      ...
      $sqlInsertLog = "INSERT INTO logs (userid, useragent, action, tableid, interactionid, error) VALUES (:userid, :useragent, 3, 4, :interactionid, 0)";
      ...
      $sqlInsertErrorLog = "INSERT INTO logs (userid, useragent, action, tableid, interactionid, error) VALUES (:userid, :useragent, 3, 4, 0, 5)";
