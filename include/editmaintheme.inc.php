      ...
      echo '
        <div class="addedit">
          <form class="form" action="php/editmaintheme.php?mainthemeid='.$_GET['mainthemeid'].'" method="POST">
            ...
            <a id="hoofdthemadelete"style="font-size:20px;font-weight: bold; float:right;"'; ?> onclick='return confirm("Weet je zekker dat je deze beeway wilt verwijderen!?")' <?php echo ' href="php/deletemaintheme.php?themeid='.$row->themeid.'" class="deletebutton" >Hoofdthema verwijderen</a>
            </div>
          </form>
        </div>
      ';
